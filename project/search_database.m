...
format = '.m4a';
[downsampled_Fs, audioMono] = import_audio2(path, song_num, format);
...
function [downsampled_Fs, resampled_audio] = import_audio2(path, song_num, format)
    % import the audio 
